import time
from excel_testdata import xlutilites
...
sheetname="Sheet1"
print("No of rows", xlutilites.getRowCount(path_of_xl, sheetname))
print("No of col", xlutilites.getColoumnCount(path_of_xl, sheetname))
